# GeoApp - Basado en una prueba técnica

## [Ver FrontEnd](https://github.com/DAndersonBurga/GeoApp-frontend)

## Contexto:
~~~
    Software Development Engineer junior (remoto)
    Objetivos:
...
## Configuración:
Modificar la configuración del datasource y crear la base de datos geoapp
````properties
    spring.datasource.url=jdbc:mysql://localhost:3306/geoapp?useSSL=false
